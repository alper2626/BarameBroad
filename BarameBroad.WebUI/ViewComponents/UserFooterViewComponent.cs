...
namespace BarameBroad.WebUI.ViewComponents
{
    public class UserFooterViewComponent : ViewComponent
    {
        ...
        string userLang;
        public UserFooterViewComponent(ICacheService cacheService, IEntityRepositoryBase<MasterProgram> repo, IHttpContextAccessor contextAccessor, IEntityRepositoryBase<MasterSiteConfig> siteConfigRepo, IEntityRepositoryBase<SocialNetworkEntity> socialRepo)
        {
